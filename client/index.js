...
require('./app/renglones/renglones.controller.js');
require('./app/renglones/renglones.js');
require('./components/footer/footer.directive.js');
require('./components/modal/modal.service.js');
require('./components/modal/modals.renglon.js');
...
require('./app/administracion/renglones/renglones.controller.js');
require('./app/administracion/renglones/renglones.js');
...
require('./components/modal/renglon/addRenglon.controller.js');
require('./components/modal/renglon/editRenglon.controller.js');
...
require('./components/services/Api/api.categoria.js');
require('./components/services/Api/api.js');
require('./components/services/Api/api.renglon.js');
