...
//cuenta el número de conversaciones que tiene el usuario
exports.countConversaciones = function(data,callback){
  var query = "call sp_sel_count_conversaciones_usuario(?);"
  connection(query, data, function(err, rows) {
    var code = 0;
    if (err) {
      code = 1;
